...
- [2026-05-13T20:25:00Z] Completed: audit all upstream `slskd/slskd` PRs and issues updated since the December 2025 fork point and write a slskdN action intake note with full source inventory.
- [2026-05-13T20:25:00Z] Follow-up: triage `docs/dev/upstream-intake-action-notes-2026-05-13.md` release-blocking candidates before the next release.
- [2026-05-13T20:45:00Z] Completed: action the relevant non-duplicate intake hardening items by tightening peer/mesh stream ticket validation, adding config compatibility warning tests, verifying existing transfer/search/upload/group/blacklist/Lidarr-Wishlist coverage, and checking current NuGet/npm vulnerability posture.
- [2026-05-13T20:45:00Z] Follow-up: treat PWA, custom theming, large Browse redesign, and wider UX productization as separate feature work rather than release-hardening.
