...
expect_literal packaging/linux/install-from-release.sh 'slskdn-main-linux-glibc-x64.zip'
expect_literal packaging/linux/install-from-release.sh 'slskdn-main-linux-glibc-arm64.zip'
expect_literal packaging/proxmox-lxc/setup-inside-ct.sh 'slskdn-main-linux-glibc-x64.zip'
