...
expect_literal packaging/aur/PKGBUILD 'install -Dm644 "src/slskdN.VpnAgent/systemd/slskdN-vpn-ingress.service" "${pkgdir}/usr/lib/systemd/system/slskdN-vpn-ingress.service"'
expect_literal packaging/aur/PKGBUILD-bin 'install -Dm644 "${stage_root}/vpn-agent/systemd/slskdN-vpn-ingress.service" "${pkgdir}/usr/lib/systemd/system/slskdN-vpn-ingress.service"'
