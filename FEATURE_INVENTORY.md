...
| Hash-from-audio-file | Audio hash from PCM | `HashFromAudioFileEnabled` / flags hash-from-audio | validator blocks/unavailable | unknown | SongID/Library | unknown | none | none | broken | remove | Startup validator says PCM extraction unavailable. |
