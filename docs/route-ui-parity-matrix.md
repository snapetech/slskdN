...
| Configuration | `/api/v0/options`, system config surfaces | Options/System pages | Mostly covered | Route policy, inventory generator, and first active legacy alias tranche are implemented. |
