...
namespace slskd.HashDb
{
    ...
    public partial interface IHashDbService
    {
        ...
        /// <summary>
        ///     Looks up hash entries for the requested MusicBrainz recording identifiers.
        /// </summary>
        Task<IEnumerable<HashDbEntry>> LookupHashesByRecordingIdsAsync(
        ...
        /// <summary>
        ///     Looks up hashes by exact FLAC keys in bounded batches.
        /// </summary>
        Task<List<HashDbEntry>> LookupHashesByFlacKeysAsync(
        ...
        /// <summary>
        ///     Gets the best deduplicated variant for a recording.
        /// </summary>
        Task<AudioVariant?> GetBestVariantByRecordingAsync(string recordingId, CancellationToken cancellationToken = default);
        ...
        /// <summary>
        ///     Gets a bounded recent recording-ordered variant sample.
        /// </summary>
        ...
        Task<List<LibraryHealth.LibraryIssue>> GetLibraryIssuesByIdsAsync(IEnumerable<string> issueIds, CancellationToken cancellationToken = default);
        Task<List<LibraryHealth.LibraryIssue>> GetLibraryIssuesByRemediationJobAsync(string jobId, LibraryHealth.LibraryIssueStatus status, CancellationToken cancellationToken = default);
        ...
        Task<int> UpdateLibraryIssueStatusesAsync(IEnumerable<string> issueIds, LibraryHealth.LibraryIssueStatus status, string? remediationJobId = null, CancellationToken cancellationToken = default);
        ...
        Task<List<Transfers.MultiSource.Metrics.PeerPerformanceMetrics>> GetPeerMetricsAsync(IEnumerable<string> peerIds, CancellationToken cancellationToken = default);
