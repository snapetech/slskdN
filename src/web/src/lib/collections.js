...
export const getShareGroup = (id) => api.get(`/sharegroups/${encodeURIComponent(id)}`);
export const createShareGroup = (data) => api.post('/sharegroups', data);
export const updateShareGroup = (id, data) =>
  api.put(`/sharegroups/${encodeURIComponent(id)}`, data);
export const deleteShareGroup = (id) => api.delete(`/sharegroups/${encodeURIComponent(id)}`);
export const getShareGroupMembers = (id, detailed = false) =>
  api.get(`/sharegroups/${encodeURIComponent(id)}/members${detailed ? '?detailed=true' : ''}`);
export const addShareGroupMember = (id, data) =>
  api.post(`/sharegroups/${encodeURIComponent(id)}/members`, data);
export const removeShareGroupMember = (id, userId) =>
  api.delete(`/sharegroups/${encodeURIComponent(id)}/members/${encodeURIComponent(userId)}`);

// Collections
export const getCollections = () => api.get('/collections');
export const getCollection = (id) => api.get(`/collections/${encodeURIComponent(id)}`);
export const createCollection = (data) => api.post('/collections', data);
export const updateCollection = (id, data) =>
  api.put(`/collections/${encodeURIComponent(id)}`, data);
export const deleteCollection = (id) => api.delete(`/collections/${encodeURIComponent(id)}`);
...
export const updateShare = (id, data) => api.put(`/share-grants/${encodeURIComponent(id)}`, data);
export const deleteShare = (id) => api.delete(`/share-grants/${encodeURIComponent(id)}`);
