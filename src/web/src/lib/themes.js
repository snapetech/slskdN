...
const computeCssOverrides = (t) => {
  ...
  return {
    ...
    '--slskdn-accent-warm': sec(5),
    '--slskdn-accent-warm-hover': sec(4),
    '--slskdn-accent-warm-muted': `rgba(${secRgb(5)}, 0.20)`,
    '--slskdn-nav-background': s(9),
    '--slskdn-nav-border': `rgba(${secRgb(5)}, 0.34)`,
    '--slskdn-footer-background': `linear-gradient(135deg, ${s(9)}, ${s(7)}, ${s(10)})`,
    '--slskdn-footer-shadow': `0 -10px 30px rgba(0,0,0,0.58), 0 -1px 0 rgba(${secRgb(5)}, 0.28)`,
    ...
    '--slskdn-theme-menu-shadow': `0 16px 38px rgba(0,0,0,0.58), 0 0 22px rgba(${pRgb(5)}, 0.12)`,
    '--slskdn-surface-shadow': `0 18px 46px rgba(0,0,0,0.34), inset 0 1px 0 rgba(255,255,255,0.045)`,
    '--slskdn-surface-shadow-soft': `0 8px 24px rgba(0,0,0,0.28), inset 0 1px 0 rgba(255,255,255,0.035)`,
