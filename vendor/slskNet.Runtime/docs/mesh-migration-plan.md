...
- File-transfer and distributed-network connections are not modified.
- Peer-message obfuscation remains opt-in and must not displace the regular peer-message listener.
