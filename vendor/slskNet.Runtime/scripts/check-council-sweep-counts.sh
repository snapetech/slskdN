...
require_closed_count "Task, cancellation, timer, and semaphore lifecycle candidates" 211 "docs/dev/bug-council-sweep-lifecycle-2026-05-05.md" "lifecycle broad sweep count matches scanner"
require_closed_count "Non-idempotent task completion candidates" 0 "docs/dev/bug-council-sweep-lifecycle-2026-05-05.md" "lifecycle non-idempotent task completion sweep count matches scanner"
...
require_closed_count "Lifecycle cancellation registration candidates" 59 "docs/dev/bug-council-sweep-lifecycle-2026-05-05.md" "lifecycle cancellation sweep count matches scanner"
