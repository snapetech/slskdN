...
require_pattern "ProtocolArgumentValidator" "src/Messaging/Messages/ProtocolArgumentValidator.cs" "outbound scalar argument validator exists"
require_pattern "RequireNonNegative\\(id, nameof\\(id\\)" "src/Messaging/Messages/Server/AcknowledgePrivateMessageCommand.cs" "private message acknowledgements reject negative ids"
require_pattern "RequireNonNegative\\(id, nameof\\(id\\)" "src/Messaging/Messages/Server/AcknowledgePrivilegeNotificationCommand.cs" "privilege notification acknowledgements reject negative ids"
require_pattern "RequirePositive\\(days, nameof\\(days\\)" "src/Messaging/Messages/Server/GivePrivilegesCommand.cs" "privilege grants reject non-positive durations"
require_pattern "RequireNonNegative\\(token, nameof\\(token\\)" "src/Messaging/Messages/Peer/TransferRequest.cs" "transfer requests reject negative tokens"
require_pattern "RequireNonNegative\\(token, nameof\\(token\\)" "src/Messaging/Messages/Initialization/PeerInit.cs" "peer initialization rejects negative tokens"
...
require_pattern "ProtocolScalarEmissionTests" "tests/Soulseek.Tests.Unit/Messaging/Messages/ProtocolScalarEmissionTests.cs" "grouped protocol scalar emission tests are registered"
