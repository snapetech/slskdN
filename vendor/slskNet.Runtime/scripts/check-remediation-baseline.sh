...
require_pattern "Task, cancellation, timer, and semaphore lifecycle candidates: 203/203 classified" "docs/dev/bug-council-sweep-lifecycle-2026-05-05.md" "lifecycle broad sweep is closed"
